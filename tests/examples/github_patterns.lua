return function(T)
    ...
    T.test("example: github spoon folder pattern", function()
        ...
        T.assertEqual(explanation.definition.source.pattern_spoonFolderPattern, T.SpoonManager.options.patterns.spoonRepo)
        T.assertEqual(explanation.definition.target.selection_spoon, "DeepFolder")
    ...
    T.test("example: spoon repo zip sugar", function()
        ...
        T.assertEqual(explanation.definition.source.pattern_spoonZipPattern, T.SpoonManager.options.patterns.spoonRepoZip)
        T.assertEqual(explanation.definition.target.selection_spoon, "DeepFolder")
        T.assertEqual(explanation.command.from.type, "remote-zip")
