return function(T)
    T.test("example: github folder", function()
        ...
        T.assertEqual(explanation.command.from.url, "https://github.com/muescha/SpoonRepo/archive/main.zip")
    ...
    T.test("example: github folder with ref", function()
        ...
        T.assertEqual(explanation.command.from.url, "https://github.com/muescha/SpoonRepo/archive/v1.2.3.zip")
