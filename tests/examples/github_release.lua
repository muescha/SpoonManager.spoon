return function(T)
    T.test("example: github latest release", function()
        ...
        T.assertEqual(explanation.source.release_releaseLatest, true)
        T.assertEqual(explanation.target.selection_asset, "DeepFolder.zip")
    ...
    T.test("example: github tagged release", function()
        ...
        T.assertEqual(explanation.source.release_release, "v1.2.3")
