return function(T)
    T.test("example: local folder spoon", function()
        ...
        T.assertEqual(explanation.source.type, "local-folder")
        T.assertEqual(explanation.source.path, "~/Projects/DeepFolder.spoon")
    ...
    T.test("example: local zip", function()
        ...
        T.assertEqual(explanation.source.type, "local-zip")
        T.assertEqual(explanation.source.path, "~/Downloads/DeepFolder.spoon.zip")
