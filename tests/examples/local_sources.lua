return function(T)
    T.test("example: local folder spoon", function()
        ...
        T.assertEqual(explanation.config.source.type, "local-folder")
        T.assertEqual(explanation.config.source.path, "~/Projects/DeepFolder.spoon")
    ...
    T.test("example: local folder repository selection", function()
        ...
        T.assertEqual(explanation.config.target.selection_folder, "Source/DeepFolder.spoon")
        T.assertEqual(explanation.command.from.type, "local-folder")
    ...
    T.test("example: local zip", function()
        ...
        T.assertEqual(explanation.config.source.type, "local-zip")
        T.assertEqual(explanation.config.source.path, "~/Downloads/DeepFolder.spoon.zip")
